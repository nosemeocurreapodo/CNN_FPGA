...
int conv2D_3x3_float32_32x28x28(hls::stream<conv_packet> &input, hls::stream<conv_packet> &output, hls::stream<conv_packet> &weights)
{
...
#pragma HLS INTERFACE s_axilite port = return
    ...
    return conv2D_Nx3x3_2<float, conv_packet, 16, 28, 28, 1>(input, output, weights);
}
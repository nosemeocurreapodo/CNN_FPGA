...
template <typename data_type, typename packet_type, int channels, int height, int width, int padding>
int conv2D_Nx3x3(hls::stream<packet_type> &input, hls::stream<packet_type> &output, hls::stream<packet_type> &weights)
{

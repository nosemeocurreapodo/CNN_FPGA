...
extern int Linear_mixed_512x512(hls::stream<weight_packet_type> &weights_s, hls::stream<bias_packet_type> &bias_s, hls::stream<input_packet_type> &input_s, hls::stream<output_packet_type> &output_s);

...
typedef ap_fixed<4, 3> weight_data_type;
typedef ap_fixed<4, 3> bias_data_type;
typedef ap_fixed<4, 3> input_data_type;
typedef float output_data_type;
...
extern int Linear_mixed_512x10(hls::stream<weight_packet_type> &weights_s, hls::stream<bias_packet_type> &bias_s, hls::stream<input_packet_type> &input_s, hls::stream<output_packet_type> &output_s);

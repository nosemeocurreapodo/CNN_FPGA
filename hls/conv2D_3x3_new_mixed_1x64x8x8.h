...
extern int conv2D_3x3_new_mixed_1x64x8x8(hls::stream<input_packet_type> &input, hls::stream<output_packet_type> &output, hls::stream<weight_packet_type> &weights);

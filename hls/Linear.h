...
extern int Linear(hls::stream<linear_packet> &input, hls::stream<linear_packet> &output, int &in_size, float weights[LINEAR_MAX_WIDTH], float bias[LINEAR_MAX_WIDTH]);
